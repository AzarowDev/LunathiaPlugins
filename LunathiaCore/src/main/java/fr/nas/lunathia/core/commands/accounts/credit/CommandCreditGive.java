package fr.nas.lunathia.core.commands.accounts.credit;
...
public class CommandCreditGive extends Command {

    public CommandCreditGive(Plugin plugin) {
        super(plugin);
        this.setAliases("credit", "c");
        this.setPermission("lunathia.account.give");
        this.setAllowConsole(false);
        this.setUsage("/account give credit");
    }
    ...
    public void execute(CommandSender sender, String[] args) throws PlayerNotFoundException {
        ...
        target.depositCredit(Integer.parseInt(args[1]));
