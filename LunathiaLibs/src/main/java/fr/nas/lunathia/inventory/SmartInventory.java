package fr.nas.lunathia.inventory;

import fr.nas.lunathia.LunathiaLibs;
import fr.nas.lunathia.inventory.content.InventoryContents;
import fr.nas.lunathia.inventory.content.InventoryProvider;
import fr.nas.lunathia.inventory.opener.InventoryOpener;
...
public class SmartInventory {
    ...
    public static final class Builder {
        ...
        public SmartInventory build() {
            ...
            InventoryManager manager = this.manager != null ? this.manager : plugin.getInventoryManager();
